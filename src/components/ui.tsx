...
export const IconWA = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg viewBox="0 0 24 24" className={className} fill="currentColor" aria-hidden>
    <path d="M12 2.2A9.8 9.8 0 0 0 3.6 17l-1.4 4.3a.5.5 0 0 0 .6.6l4.4-1.4A9.8 9.8 0 1 0 12 2.2Zm0 1.8a8 8 0 1 1-4.1 14.9l-.5-.3-2.4.8.8-2.3-.3-.5A8 8 0 0 1 12 4Zm-3 4.1c-.2 0-.6.1-.9.4-.3.4-1.1 1.1-1.1 2.6s1.2 3 1.3 3.2c.2.2 2.3 3.6 5.7 4.9 2.8 1.1 3.4.9 4 .8.6 0 2-.8 2.2-1.5.3-.8.3-1.4.2-1.5l-.6-.4-2.1-1c-.3-.1-.5-.2-.7.1l-1 1.2c-.2.2-.3.2-.6.1a6.6 6.6 0 0 1-3.3-2.9c-.2-.4 0-.5.1-.7l.6-.8c.1-.2.1-.4 0-.6L11.7 8.7c-.2-.5-.4-.6-.7-.6Z" />
  </svg>
);
