        ...
        <div className="relative max-w-7xl mx-auto px-5 md:px-8 pt-10 md:pt-16 pb-14 md:pb-20 grid lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-6">
            ...
            <Reveal delay={110}>
              ...
              <p className="mt-4 flex items-center gap-2.5 text-sm md:text-[15px] font-semibold text-ranch">
                <IconTruck className="w-5 h-5 shrink-0 text-leather" />
                Bisa diantar sampai tujuan.
              </p>
            </Reveal>
            <Reveal delay={200}>
